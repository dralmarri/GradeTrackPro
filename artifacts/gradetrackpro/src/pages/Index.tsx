...
export default function Index() {
  ...
  const [activeCourseId, setActiveCourseId] = useState<string | null>(
    isSupabaseConfigured ? null : "preview-course",
  );
  ...
  const [pendingStudentNames, setPendingStudentNames] = useState<ImportedStudent[]>([]);
  const [courseTab, setCourseTab] = useState<CourseTab>(
    isSupabaseConfigured ? "attendance" : "omr",
  );
