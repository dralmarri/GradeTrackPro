...
const previewLectures: LectureInfo[] = Array.from({ length: 10 }, (_, index) => ({
  date: new Date(2026, 8, 7 + index * 2).toISOString(),
  label: `المحاضرة ${index + 1}`,
}));

const previewStudents: Student[] = [
  { id: "s1", name: "نورة عبدالله المطيري", studentNumber: "2026001", lectureBonus: Array(10).fill(0), attendance: [true, true, false, true, true, true, true, false, true, true], lectureNotes: Array(10).fill(""), exam1: 16, exam2: 20, finalExam: 23, participation: 7, homework: 10 },
  { id: "s2", name: "ريما خالد العتيبي", studentNumber: "2026002", lectureBonus: Array(10).fill(0), attendance: [true, true, true, true, false, true, true, true, true, true], lectureNotes: Array(10).fill(""), exam1: 18, exam2: 20, finalExam: 21, participation: 7, homework: 10 },
  { id: "s3", name: "سارة محمد الشمري", studentNumber: "2026003", lectureBonus: Array(10).fill(0), attendance: [true, false, true, true, true, true, true, true, true, true], lectureNotes: Array(10).fill(""), exam1: 20, exam2: 20, finalExam: 21, participation: 9, homework: 10 },
  { id: "s4", name: "هيفاء سعد الدوسري", studentNumber: "2026004", lectureBonus: Array(10).fill(0), attendance: Array(10).fill(true), lectureNotes: Array(10).fill(""), exam1: 18, exam2: 20, finalExam: 20, participation: 7, homework: 10 },
];
