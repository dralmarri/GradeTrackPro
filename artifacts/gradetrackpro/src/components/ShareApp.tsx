...
// Use the host the user is currently viewing so the shared website link works
// in Replit preview, Vercel previews, and the eventual custom domain.
const WEB_URL = typeof window !== "undefined" ? window.location.origin : "https://gradetrackpro.com";
